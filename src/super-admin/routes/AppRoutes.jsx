...
import StoreDetails from "../../store-sub-admin/pages/StoreDetails";
import StoreDeliveryCharges from "../../store-sub-admin/pages/StoreDeliveryCharges";
import StoreItemRequirement from "../../store-sub-admin/pages/StoreItemRequirement";
import StoreItemSaleReport from "../../store-sub-admin/pages/StoreItemSaleReport";
import StoreSendNotificationUsers from "../../store-sub-admin/pages/StoreSendNotificationUsers";
import StoreSendNotificationDriver from "../../store-sub-admin/pages/StoreSendNotificationDriver";
import StoreCoupons from "../../store-sub-admin/pages/StoreCoupons";
import StoreAddCoupon from "../../store-sub-admin/pages/StoreAddCoupon";
import StorePayoutRequest from "../../store-sub-admin/pages/StorePayoutRequest";
import StoreCategoryBanner from "../../store-sub-admin/pages/StoreCategoryBanner";
import StoreAddCategoryBanner from "../../store-sub-admin/pages/StoreAddCategoryBanner";
import StoreProductBanner from "../../store-sub-admin/pages/StoreProductBanner";
import StoreAddProductBanner from "../../store-sub-admin/pages/StoreAddProductBanner";
import StoreProductList from "../../store-sub-admin/pages/StoreProductList";
import StoreAddProduct from "../../store-sub-admin/pages/StoreAddProduct";
import StoreAdminCatalog from "../../store-sub-admin/pages/StoreAdminCatalog";
...
import StoreOrders from "../../store-sub-admin/pages/StoreOrders";
...
import StoreBulkUpdate from "../../store-sub-admin/pages/StoreBulkUpdate";
import StoreOrderByPhoto from "../../store-sub-admin/pages/StoreOrderByPhoto";
import StoreDeliveryBoyList from "../../store-sub-admin/pages/StoreDeliveryBoyList";
import StoreAddDeliveryBoy from "../../store-sub-admin/pages/StoreAddDeliveryBoy";
import StoreIncentivePayouts from "../../store-sub-admin/pages/StoreIncentivePayouts";
import StoreCallbackRequests from "../../store-sub-admin/pages/StoreCallbackRequests";
import StoreSettings from "../../store-sub-admin/pages/StoreSettings";
import StoreLayout from "../../store-sub-admin/layouts/StoreLayout";
