  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      const formattedData = apiResults.map((order, index) => ({
        ...
        status: (order["Status"] || order.status || "Completed").toUpperCase(),
    ...
    <Box sx={{ p: 4, backgroundColor: "#f4f7fe", minHeight: "100vh" }}>
      ...
      <Box sx={{ mb: 4, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Box>
            ...
            <Typography variant="body1" color="textSecondary" sx={{ fontWeight: "500" }}>
                Comprehensive ledger of customer deliveries categorized by date.
            </Typography>
        </Box>
      </Box>
      ...
      <Stack direction="row" spacing={3} sx={{ mb: 4 }}>
        <Paper sx={{ p: 3, flex: 1, borderRadius: "24px", boxShadow: "0 10px 30px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", gap: 2, backgroundColor: "#fff" }}>
          ...
          <Box>
            <Typography variant="caption" color="#a3aed0" fontWeight="800" sx={{ letterSpacing: "1px" }}>TOTAL DAILY ORDERS</Typography>
                            ...
                            <Collapse in={isExpanded} timeout="auto" unmountOnExit>
                                <Box sx={{ p: 4, backgroundColor: "#fafbfc" }}>
                                    <Stack direction="row" spacing={4} alignItems="flex-start">
                                        ...
                                        <Box>
                                            <Typography variant="subtitle2" fontWeight="800" gutterBottom color="#2b3674">LOGISTICS ACTIONS</Typography>
                                            <Button variant="contained" size="small" startIcon={<FileDownloadIcon fontSize="small" />} sx={{ bgcolor: "#4318ff", borderRadius: "12px", textTransform: "none", fontWeight: "800", boxShadow: "0 10px 20px rgba(67, 24, 255, 0.2)" }}>
                                                Export Receipt
                                            </Button>
                                        </Box>
                                    </Stack>
