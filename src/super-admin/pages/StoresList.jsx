...
const StoresList = () => {
  ...
  const openStorePage = (storeId) => {
    if (!storeId) return;
    window.open(`/stores/details/${encodeURIComponent(storeId)}/dashboard`, "_blank");
  };
          ...
          <Table stickyHeader>
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center" sx={{ backgroundColor: "#fafbfc", color: "#a3aed0", fontWeight: "800", fontSize: "11px", borderBottom: "1px solid #e0e5f2" }}>STORE PAGE</TableCell>
