  ...
  useEffect(() => {
    const fetchCatalogProducts = async () => {
      try {
        ...
        console.error("Unable to load store order quantity:", error);
            ...
            <Table>
              <TableHead sx={{ bgcolor: "#fafbfc" }}>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 900, color: "#a3aed0" }}>Current Limit</TableCell>
                  <TableCell sx={{ fontWeight: 900, color: "#a3aed0" }}>Add Limit</TableCell>
...
export default StoreUpdateOrderQuantity;
